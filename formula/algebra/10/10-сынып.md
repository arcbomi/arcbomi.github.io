...
\\
1)&\text{Егер } f(x) \text{ функциясы [a,b] интервалында дифференциацияланатын функция болса, және } f(a)=f(b) \text{ болса онда } \exists x_0:f^\prime(x_0)=0 (x_0\in [a,b]) \\
2)&\text{Егер } f(x) \text{ функциясы [a,b] интервалында дифференциацияланатын функция болса, онда } \exists x_0\in [a,b]:f^\prime(x_0)=\frac{f(a)-f(b)}{a-b} \\
3)&f(x), g(x)\text{ функциялары [a,b] интервалында дифференфиацияланатын функциялар болсын және  } g^\prime(x)\neq 0 \ \forall x\in [a,b]; \text{онда } \exists x_0\in[a,b]: \frac{f(b)-f(a)}{g(b)-g(a)}=\frac{f^\prime(x_0)}{g^\prime(x_0)}\\
